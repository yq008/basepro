...
import com.yq008.basepro.applib.widget.recyclerview.animation.AlphaInAnimation;
import com.yq008.basepro.applib.widget.recyclerview.animation.BaseAnimation;
import com.yq008.basepro.applib.widget.recyclerview.animation.ScaleInAnimation;
import com.yq008.basepro.applib.widget.recyclerview.animation.SlideInBottomAnimation;
import com.yq008.basepro.applib.widget.recyclerview.animation.SlideInLeftAnimation;
import com.yq008.basepro.applib.widget.recyclerview.animation.SlideInRightAnimation;
import com.yq008.basepro.applib.widget.recyclerview.entity.IExpandable;
import com.yq008.basepro.applib.widget.recyclerview.loadmore.LoadMoreView;
import com.yq008.basepro.applib.widget.recyclerview.loadmore.SimpleLoadMoreView;
 ...
 */
public abstract class RecyclerBaseAdapter<ADT, HT extends RecyclerViewHolder> extends RecyclerView.Adapter<HT> {
    ...
    public void addData(List<ADT> newData) {
        ...
        notifyAdapter(newData);

    }
    /**
     * add by Xiay
     * Refresh complete
     * 避免由于 RecyclerView is computing a layout or scrolling 崩溃
     */
    private void notifyAdapter(final List<ADT> newData) {
    ...
    @Override
    public HT onCreateViewHolder(ViewGroup parent, int viewType) {
        HT baseViewHolder = null;
    ...
    private HT getLoadingView(ViewGroup parent) {
        View view = getItemView(mLoadMoreView.getLayoutId(), parent);
        HT holder = createBaseViewHolder(view);
     ...
     */
    @Override
    public void onViewAttachedToWindow(HT holder) {
     ...
     */
    @Override
    public void onBindViewHolder(HT holder, int positions) {
        ...
        view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (getOnItemClickListener() != null && baseViewHolder != null) {
                    ...
                    getOnItemClickListener().onItemClick(RecyclerBaseAdapter.this, v, baseViewHolder.getLayoutPosition() - getHeaderLayoutCount());
                }
    ...
    protected HT onCreateDefViewHolder(ViewGroup parent, int viewType) {
        return createBaseViewHolder(parent, mLayoutResId);
    }

    protected HT createBaseViewHolder(ViewGroup parent, int layoutResId) {
     ...
     */
    protected HT createBaseViewHolder(View view) {
        Class temp = getClass();
        Class z = null;
        ...
        HT k = createGenericKInstance(z, view);
        return null != k ? k : (HT) new RecyclerViewHolder(view);
    }

    /**
     * try to create Generic HT instance
     *
     * @param z
     * @param view
     * @return
     */
    private HT createGenericKInstance(Class z, View view) {
        try {
            ...
            if (className.contains("$") && !buffer.contains("static")) {
                ...
                return (HT) constructor.newInstance(this, view);
            } else {
                constructor = z.getDeclaredConstructor(View.class);
                return (HT) constructor.newInstance(view);
            }
     ...
     */
    protected abstract void convert(HT helper, ADT item);
