...
import com.yq008.basepro.applib.widget.recyclerview.listener.OnItemSwipeListener;

import java.util.Collections;
import java.util.List;


public abstract class RecyclerItemDraggableAdapter<T> extends RecyclerAdapter<T> {
