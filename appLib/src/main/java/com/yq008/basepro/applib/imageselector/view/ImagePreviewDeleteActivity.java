...
import com.yq008.basepro.applib.imageselector.widget.PreviewViewPager;
        ...
        if (!isPreview){
            ...
            iv_delete.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    isDelete=true;
                    //onDoneClick(true);
                    new MyDialog(ImagePreviewDeleteActivity.this).showCancleAndSure("提示信息","确定要删除该照片吗？","取消","删除",new DialogClickListener() {
                        @Override
                        public void onClick(View v) {
