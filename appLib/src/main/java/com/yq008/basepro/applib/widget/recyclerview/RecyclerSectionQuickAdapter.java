...
import com.yq008.basepro.applib.widget.recyclerview.entity.SectionEntity;

import java.util.List;

public abstract class RecyclerSectionQuickAdapter<T extends SectionEntity> extends RecyclerAdapter {
