...
public class LoadingLayout extends FrameLayout {
    ...
    private void build() {
        ...
        errorPage = LayoutInflater.from(mContext).inflate(R.layout.loading_error_page, null);
        emptyPage = LayoutInflater.from(mContext).inflate(R.layout.loading_empty_page, null);
        networkPage = LayoutInflater.from(mContext).inflate(R.layout.loading_nonetwork_page, null);
        ...
        if (mConfig.buttonHeight != -1) {
            ...
            errorReloadBtn.setHeight(AutoUtils.getHeightSize(mConfig.buttonHeight));
            networkReloadBtn.setHeight(AutoUtils.getHeightSize(mConfig.buttonHeight));
        }
        if (mConfig.buttonWidth != -1) {

            errorReloadBtn.setWidth(AutoUtils.getWidthSize(mConfig.buttonWidth));
            networkReloadBtn.setWidth(AutoUtils.getWidthSize(mConfig.buttonWidth));
        }
    ...
    public static class Config {
        ...
        int emptyImgId = R.mipmap.loading_empty;
        int errorImgId = R.mipmap.loading_error;
        int networkImgId = R.mipmap.loading_nonetwork;
        int reloadBtnId = R.drawable.btn_gray_selector;
        int tipTextSize = 14;
        int buttonTextSize = 14;
        int tipTextColor = R.color.text_gray6;
        int buttonTextColor = R.color.text_gray6;
        int buttonWidth = -1;
        int buttonHeight = -1;
        int loadingLayoutId = R.layout.loading_loading_page;
        View loadingView = null;
        int backgroundColor = R.color.gray_bg;
